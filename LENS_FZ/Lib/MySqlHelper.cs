...
namespace LENS_FZ
{
    ...
    public class MySqlHelper
    {
        ...
        public MySqlHelper(string DataBase, string IP,string User,string Password)
        {
            this.Conn = "Database="+DataBase+";Data Source="+IP+";User Id="+User+";Password="+Password+";charset='utf8';pooling=true";
        }
